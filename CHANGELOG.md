...
- Added typed Microsoft CLI commands for Outlook mail, calendar and contacts; OneDrive and SharePoint files and lists; Teams reads; Microsoft To Do lists and tasks; and Planner tasks.
...
- Added the bundled `aai-microsoft` Agent Skill, Microsoft command/auth documentation, and an architecture decision record.
